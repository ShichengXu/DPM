...
public class FinalProject {
	...
	//	final TextLCD t = LocalEV3.get().getTextLCD();
		...
		nav = new Navigation (leftMotor,rightMotor,odo,usValue,usData,touch1,touch2,touchSample1,touchSample2,sensorMotor);
		searching search= new searching( leftMotor, rightMotor,sensorMotor, odo, usSensor, usData,
				   touch1, touch2,  touchSample1, touchSample2,nav);
