...
public class Localization {
	...
	public double theta;
	private static double leftR = 2.2, rightR = 2.2, width = 15.3, thetaTurn;
	...
	public void doLocalization() {
		...
		if (locType == LocalizationType.FALLING_EDGE) {              //falling edge
			...
			odo.setPosition(new double[] { 0.0, 0.0, 90.0 }, new boolean[] {   //update the odometer to 0,0,90 (to make our second part easier )
					true, true, true });
			...
			while(moveX==true)
			{
				...
				if (touchSample1[0]==1 && touchSample2[0]==1)
				{
					leftMotor.stop(true);
					rightMotor.stop(false);
					odo.setPosition(new double[] { -20.0, 0.0, 0.0 }, new boolean[] {true, false, false});
					break;
				}
				
			}
			
			leftMotor.rotate(convertDistance(2.1,-20.0),true);
			rightMotor.rotate(convertDistance(2.1,-20.0),false);
			turnAngle(92);
			...
			while(moveY==true)
			{
				...
				if (touchSample1[0]==1 && touchSample2[0]==1)
				{
					leftMotor.stop(true);
					rightMotor.stop(false);
					odo.setPosition(new double[] { 0.0, -20.0, 270.0 }, new boolean[] {false, true, true});
					break;
				}
